    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { to: '/delivery-zones', label: 'مناطق التوصيل', icon: Truck },
          { to: '/delivery-account', label: 'كشف حساب التوصيل', icon: DollarSign },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: CreditCard,
        items: [
          { to: '/finance/accounting', icon: LayoutDashboard, label: 'المحاسبة', module: 'journal_entries' },
          ...
          { to: '/finance/accounts', icon: Scale, label: 'دليل الحسابات', module: 'journal_entries' },
          { to: '/finance/ledger', icon: BookOpen, label: 'الأستاذ العام', module: 'journal_entries' },
          { to: '/finance/profit-loss', icon: TrendingUp, label: 'الأرباح والخسائر', module: 'journal_entries' },
          { to: '/finance/balance-sheet', icon: Scale, label: 'الميزانية العمومية', module: 'journal_entries' },
